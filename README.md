...
#### If you don't have them already, you need to install the following dependencies:
```bash
sudo apt-get update
sudo apt-get upgrade
sudo apt-get install make cmake wget default-jdk unzip python3 build-essential
```

#### If you have already installed ANTLR4, you can remove it using the following command:
```bash
sudo apt-get remove antlr4 antlr4-runtime-dev
```
